...
class Profile(models.Model):  #
    user = models.OneToOneField(User, on_delete=models.CASCADE)  # one to one relationship with User model used for authentication. CASCADE-> if User is deleted, Profile will be deleted
    image = models.ImageField(default='default.jpg', upload_to='profile_pics')  # images uploaded to profile_pics directory

    def __str__(self):  # this function is called whenever 'print' or 'str' converts object into a string
    ...
    # *args, **kwargs allow for variable number of inputs
